...
int main() {
  ...
  int mealChoice, appetizerChoice, drinkChoice, closingChoice;
  ...
  do {
    ...
    std::cout << "--- Menu ---\n"
              ...
              << std::setw(10) << "P 30\n"
              << std::left << std::setw(30) << "2. Pineapple Juice"
              << std::right << std::setw(10) << "P 80\n"
    ...
    std::cout << "Hi! " << name << std::endl
              << "Your orders are:\n"
              << ordersList << "Your Total: " << totalOfItemsBought
              << std::endl;
